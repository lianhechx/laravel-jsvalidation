...
use Mockery as m;
use Opbol\JsValidation\Exceptions\PropertyNotFoundException;
use Opbol\JsValidation\Javascript\JavascriptValidator;
...
class JavascriptValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRender()
    {
        ...
        $mockHandler = $this->getMockBuilder('\Opbol\JsValidation\Javascript\ValidatorHandler')
