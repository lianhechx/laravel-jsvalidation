...
namespace Opbol\JsValidation\Tests;
use Mockery as m;
use Opbol\JsValidation\Exceptions\FormRequestArgumentException;
use Opbol\JsValidation\JsValidatorFactory;
...
class JsValidatorFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMake() {
        ...
        $this->assertInstanceOf('Opbol\JsValidation\Javascript\JavascriptValidator', $jsValidator);
    ...
    public function testCreateFromFormRequestClassName() {
        ...
        $app->expects($this->once())
            ->method('build')
            ->with('Opbol\JsValidation\Tests\StubFormRequest')
            ->willReturn($mockForm);
        ...
        $jsValidator = $factory->formRequest(['Opbol\JsValidation\Tests\StubFormRequest'] , $selector);
